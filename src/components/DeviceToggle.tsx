    ...
    <section id="demo" className="py-24 bg-[#09090D] border-t border-b border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs text-cyber-lime font-mono mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="p-6 rounded-2xl glass-card relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-semibold text-sm">iPhone 16 Pro Max</span>
                    <span className="text-xs font-mono text-gray-500">iOS</span>
                  </div>
                  <span className="text-xs text-gray-400 block mt-1">Sleek Curve, Dynamic Island</span>
                  {device === "iphone" && (
                    <span className="absolute bottom-2 right-2 text-cyber-lime text-xs">● Active</span>
                  )}
                </button>
                ...
                >
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-semibold text-sm">Galaxy S24 Ultra</span>
                    <span className="text-xs font-mono text-gray-500">Android</span>
                  </div>
                  <span className="text-xs text-gray-400 block mt-1">Symmetrical Bezel, Sharp Boxy</span>
                  {device === "samsung" && (
                    <span className="absolute bottom-2 right-2 text-cyber-lime text-xs">● Active</span>
                  )}
                </button>
              ...
              <div className="mt-4 p-3 rounded-lg bg-black/40 border border-white/5 text-xs text-gray-400 font-mono">
                {device === "iphone" ? (
                  <p>📸 <span className="text-white">Apple ProRes Log:</span> Captured in ultra-wide gamut color-space at 10-bit deep resolution, graded professionally on DaVinci Resolve.</p>
                ) : (
                  <p>🤖 <span className="text-white">Samsung 200MP Raw:</span> Dynamic HDR and insane low-light performance inside dark pubs, dance floors, and private lounges.</p>
                )}
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {DEMO_VIBES.filter((v) => v.category === "single").map((v) => (
                      <button
                        ...
                        className={`py-3 px-4 rounded-xl text-xs font-medium border text-left transition-all cursor-pointer flex items-center gap-2 ${
                          activeVibeId === v.id
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-r from-cyber-lime/10 to-indigo-500/10 border border-white/5 flex gap-4 items-start">
              <div className="p-2.5 rounded-xl bg-cyber-lime/10 text-cyber-lime shrink-0">
                <Award className="h-6 w-6" />
              </div>
              <div>
                <h4 className="text-sm font-bold text-white mb-0.5">Zero Intrusive Crews</h4>
          ...
          <div className="lg:col-span-7 flex flex-col items-center justify-center">
            ...
            <div className="relative transition-all duration-500">
              ...
              {device === "iphone" ? (
                <div 
                  className="w-[310px] h-[610px] sm:w-[330px] sm:h-[650px] bg-[#1a1a24] rounded-[52px] p-[10px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8),_0_0_40px_rgba(204,255,0,0.05)] border-3 border-[#2E2E3E] relative"
                  id="iphone-shell"
                >
                  {/* Subtle Apple Buttons overlay */}
                  <div className="absolute top-[100px] -left-[3px] w-[3px] h-[40px] bg-[#2E2E3E] rounded-r" />
                  <div className="absolute top-[150px] -left-[3px] w-[3px] h-[50px] bg-[#2E2E3E] rounded-r" />
                  <div className="absolute top-[210px] -left-[3px] w-[3px] h-[50px] bg-[#2E2E3E] rounded-r" />
                  <div className="absolute top-[160px] -right-[3px] w-[3px] h-[65px] bg-[#2E2E3E] rounded-l" />
                  
                  {/* Outer Speaker slot */}
                  <div className="absolute top-[5px] left-1/2 -translate-x-1/2 w-24 h-1 bg-[#101015] rounded-full z-30" />

                  {/* Inner screen glass container */}
                  <div className="w-full h-full rounded-[43px] overflow-hidden bg-black relative border border-white/5 flex flex-col justify-between">
                    
                    {/* Dynamic Island Overlay */}
                    <div className="absolute top-3.5 left-1/2 -translate-x-1/2 w-28 h-[25px] bg-black rounded-full z-40 flex items-center justify-between px-3 text-[9px] font-mono text-gray-500 pointer-events-none">
                      <span className="text-cyber-lime">●</span>
                      <div className="flex items-center gap-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse" />
                        <span className="text-[8px] text-white/80">LIVE</span>
                      </div>
                    </div>
                ...
                <div 
                  className="w-[310px] h-[610px] sm:w-[330px] sm:h-[650px] bg-[#1d1d23] rounded-[24px] p-[8px] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8),_0_0_40px_rgba(204,255,0,0.05)] border-3 border-[#3A3A4A] relative"
                  id="samsung-shell"
                >
                  {/* Symmetrical buttons */}
                  <div className="absolute top-[140px] -right-[3px] w-[3px] h-[55px] bg-[#3A3A4A] rounded-l" />
                  <div className="absolute top-[205px] -right-[3px] w-[3px] h-[80px] bg-[#3A3A4A] rounded-l" />

                  {/* Inner screen glass container - sharper corners */}
                  <div className="w-full h-full rounded-[18px] overflow-hidden bg-black relative border border-white/5 flex flex-col justify-between">
                    
                    {/* Tiny Punch Hole Camera */}
                    <div className="absolute top-3 left-1/2 -translate-x-1/2 w-3.5 h-3.5 bg-black rounded-full z-40 border border-white/10 pointer-events-none" />
              ...
              <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-black/80 backdrop-blur-md px-4 py-2.5 rounded-full border border-white/10 flex items-center gap-4 shadow-lg z-40 text-xs font-mono">
        ...
        {activeVibe.category === "multi" ? (
          ...
          <div className="flex-1 flex flex-col justify-center py-2 space-y-2">
            ...
            <div className="grid grid-rows-2 gap-2 flex-1">
              ...
              {/* Angle B - Galaxy Ultra Telephoto */}
              <div className="rounded-xl border border-white/10 bg-black/40 overflow-hidden relative flex flex-col items-center justify-center p-3 text-center">
                <span className="absolute top-1 right-2 text-[8px] font-mono text-[#38BDF8] bg-black/60 px-1 rounded">CAM B (TIGHT)</span>
                <span className="text-xl">✨</span>
                <span className="text-[10px] font-bold text-white mt-1">Telephoto Facial Expression</span>
                <span className="text-[8px] text-gray-400 font-mono mt-0.5">200MP Detail Boost</span>
                {isPlaying && (
                  <div className="absolute bottom-1 left-2 flex items-center gap-1 text-[8px] text-red-500 font-mono animate-pulse">
                    <span>● REC</span>
                  </div>
